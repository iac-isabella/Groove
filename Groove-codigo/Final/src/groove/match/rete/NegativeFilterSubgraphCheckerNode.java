 ...
 *
 * $Id: NegativeFilterSubgraphCheckerNode.java 5479 2014-07-19 12:20:13Z rensink $
 */
...
public class NegativeFilterSubgraphCheckerNode<LeftMatchType extends AbstractReteMatch,RightMatchType extends AbstractReteMatch>
     ...
     */
    private int receiveNegativeMatch(ReteNetworkNode source,
    ...
    protected class BidirectionalInhibitionMap {
        ...
        public void add(AbstractReteMatch inhibitor, AbstractReteMatch inhibited) {
            Set<AbstractReteMatch> inhibitorSet =
                this.positiveToNegative.get(inhibited);
            ...
            Set<AbstractReteMatch> inhibitedSet =
         ...
         */
        public Set<AbstractReteMatch> removeInhibitor(
                AbstractReteMatch inhibitor) {
