 ...
 *
 * $Id: ReteNetworkNode.java 5479 2014-07-19 12:20:13Z rensink $
 */
...
public abstract class ReteNetworkNode {
    ...
    private ArrayList<ReteNetworkNode> antecedents = new ArrayList<ReteNetworkNode>();
     ...
     */
    public abstract void receive(ReteNetworkNode source, int repeatIndex, AbstractReteMatch match);
