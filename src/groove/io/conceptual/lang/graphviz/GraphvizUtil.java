 ...
 *
 * $Id: GraphvizUtil.java 5479 2014-07-19 12:20:13Z rensink $
 */
...
public class GraphvizUtil {
    ...
    private static TypeModel buildStaticModel() {
        ...
        g_AttrField =
            new Field(Name.getName("attributes"), new Container(Kind.SET, StringType.instance()),
                0, -1);
        ...
        g_EdgeField =
            new Field(Name.getName("edge"), new Container(Kind.SET, g_NodeClass.getProperClass()),
                0, -1);
