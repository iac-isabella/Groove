...
/*
 * $Id: LayoutIO.java 5480 2014-07-19 22:15:15Z rensink $
 */
...
public class LayoutIO {
     ...
     */
    private AttrEdge putEdgeLayout(LayoutMap layoutMap, String[] parts, AttrGraph graph, int version)
        throws FormatException {
        if (parts.length < 7) {
    ...
    private static final String LAYOUT_FORMAT_ERROR = String.format("Error in %s file",
        FileType.LAYOUT.getExtension());
     ...
     */
    private static final Point2D DEFAULT_EDGE_VECTOR = new Point2D.Double(50, 0);
}