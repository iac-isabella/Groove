 ...
 *
 * $Id: AbstractPathChecker.java 5479 2014-07-19 12:20:13Z rensink $
 */
...
public abstract class AbstractPathChecker extends ReteNetworkNode implements ReteStateSubscriber {
    ...
    public boolean equals(ReteNetworkNode node) {
        return (this == node)
            || ((node instanceof AbstractPathChecker) && this.getOwner().equals(node.getOwner()) && this.expression.equals(((AbstractPathChecker) node).getExpression()));
    }
    ...
    public static class PathMatchCache implements DominoEventListener {
        ...
        private HashMap<Object,CacheEntry> entries = new HashMap<Object,CacheEntry>();
