 ...
 *
 * $Id: AbstractReteMatch.java 5479 2014-07-19 12:20:13Z rensink $
 */
...
public abstract class AbstractReteMatch implements VarMap {
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AbstractReteMatch)) {
            return false;
        }
        AbstractReteMatch other = (AbstractReteMatch) obj;
        if (this.containerCollections == null) {
            if (other.containerCollections != null) {
                return false;
            }
        } else if (!this.containerCollections.equals(other.containerCollections)) {
            return false;
        }
        if (this.deleted != other.deleted) {
            return false;
        }
        if (this.dominoListeners == null) {
            if (other.dominoListeners != null) {
                return false;
            }
        } else if (!this.dominoListeners.equals(other.dominoListeners)) {
            return false;
        }
        if (this.injective != other.injective) {
            return false;
        }
        if (this.specialPrefix == null) {
            if (other.specialPrefix != null) {
                return false;
            }
        } else if (!this.specialPrefix.equals(other.specialPrefix)) {
            return false;
        }
        if (this.subMatches == null) {
            if (other.subMatches != null) {
                return false;
            }
        } else if (!this.subMatches.equals(other.subMatches)) {
            return false;
        }
        if (this.superMatches == null) {
            if (other.superMatches != null) {
                return false;
            }
        } else if (!this.superMatches.equals(other.superMatches)) {
            return false;
        }
        if (this.valuation == null) {
