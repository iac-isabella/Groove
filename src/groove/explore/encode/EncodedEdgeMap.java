 ...
 *
 * $Id: EncodedEdgeMap.java 5480 2014-07-19 22:15:15Z rensink $
 */
...
public class EncodedEdgeMap implements
    ...
    private TypeLabel parseLabel(TypeGraph typegraph, String source)
        ...
        throw new FormatException("'" + source
            + "' is not a valid edge name in the current grammar.");
    }
    ...
    public Map<TypeLabel,Integer> parse(Grammar rules, String source)
        ...
        if (source.equals("")) {
            throw new FormatException(
                "The empty string is not a valid condition edge>num.");
        }
